    ...
    <>
      ...
      <div className="policy-wrapper">
        <div className="policy-page-heading">
          <p>
            Privacy Policy-<span>Last updated: July 12, 2024</span>
          </p>
        ...
        <div>
          ...
          <div className="policy-desc">
            ...
            <p>
              ...
              in this Agreement) refers to Corusview IT Service Pvt Ltd, C-06
              prteek plams Indore (452010).
            </p>
            <p>
            ...
            <p className="sub-heading">Service refers to the Website.</p>
            <p>
            ...
            <p>
              Website refers to Corusview IT service Pvt Ltd, accessible from
              &nbsp;
              <a href="https://corusview.com">https://corusview.com</a>
            </p>
            <p>
        ...
        <div>
          ...
          <div className="policy-desc">
            <p className="sub-heading">Types of Data Collected</p>
            <p className="sub-heading">Personal Data</p>
            <p>
            ...
            <p className="sub-heading">Email address</p>
            <p className="sub-heading">Usage Data</p>
          </div>
        </div>
        <div>
          <div className="policy-heading">
        ...
        <div>
          ...
          <div className="policy-desc">
            ...
            <p className="sub-heading">Necessary / Essential Cookies</p>
            <p className="sub-heading">Type: Session Cookies</p>
            <p className="sub-heading">Administered by: Us</p>
            <p>
            ...
            <p className="sub-heading">Type: Persistent Cookies</p>
            <p className="sub-heading">Administered by: Us</p>
            <p className="sub-heading">
              Purpose: These Cookies identify if users have accepted the use of
              cookies on the Website.
            </p>
            <p className="sub-heading">Functionality Cookies</p>
            <p className="sub-heading">Type: Persistent Cookies</p>
            <p className="sub-heading">Administered by: Us</p>
            <p>
        ...
        <div>
          <div className="policy-heading">
            ...
            <p className="sub-heading">Use of Your Personal Data</p>
            <p className="sub-heading">
          ...
          <div className="policy-desc">
            ...
            <p>
              ...
              any other purpose with Your consent. Retention of Your Personal
              Data
            </p>
            <p>
            ...
            <p className="sub-heading">Transfer of Your Personal Data</p>
            <p>
            ...
            <p className="sub-heading">Delete Your Personal Data</p>
            <p>
        ...
        <div>
          <div className="policy-heading">
            ...
            <p className="sub-heading">Business Transactions</p>
          </div>
          <div className="policy-desc">
            <p>
            ...
            <p className="sub-heading">Law enforcement</p>
            <p>
            ...
            <p className="sub-heading">Other legal requirements</p>
            <p className="sub-heading">
              The Company may disclose Your Personal Data in the good faith
              belief that such action is necessary to:
            </p>
            <p className="sub-heading">Comply with a legal obligation</p>
            <p className="sub-heading">
            ...
            <p className="sub-heading">Protect against legal liability</p>
            <p className="sub-heading">Security of Your Personal Data</p>
            <p>
            ...
            <p className="sub-heading">Children's Privacy</p>
            <p>
            ...
            <p className="sub-heading">Links to Other Websites</p>
            <p>
            ...
            <p className="sub-heading">Changes to this Privacy Policy</p>
            <p>
        ...
        <div>
          ...
          <div className="policy-desc">
            ...
            <p>
              By email:{" "}
              <a href="mailto:contact@corusview.com">contact@corusview.com</a>
            </p>
          </div>
        </div>
      </div>
